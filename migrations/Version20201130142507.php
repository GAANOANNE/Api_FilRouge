 ...
 */
final class Version20201130142507 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apprenant (id INT NOT NULL, date_naissance DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE profil_de_sortie DROP FOREIGN KEY FK_8F96B7F6C5697D6D');
        $this->addSql('ALTER TABLE profil_de_sortie ADD CONSTRAINT FK_8F96B7F6C5697D6D FOREIGN KEY (apprenant_id) REFERENCES apprenant (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profil_de_sortie DROP FOREIGN KEY FK_8F96B7F6C5697D6D');
        $this->addSql('ALTER TABLE profil_de_sortie ADD CONSTRAINT FK_8F96B7F6C5697D6D FOREIGN KEY (apprenant_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
